...
public class SpaceSlime extends Applet implements Runnable {
   private int nWidth;
   private int nHeight;
   private int p1Score;
   private int p2Score;
   ...
   public void paint(Graphics g) {
      ...
      if(!this.fInPlay) {
         ...
         this.screen.setColor(Color.white);
         if(this.fSuperSlime) {
            this.screen.drawString("Super Space Slime+!", this.nWidth / 2 - fontmetrics.stringWidth("Super Soccer Slime!") / 2, this.nHeight / 2 - fontmetrics.getHeight());
         } else {
            this.screen.drawString("Space Slime+!", this.nWidth / 2 - fontmetrics.stringWidth("Soccer Slime!") / 2, this.nHeight / 2 - fontmetrics.getHeight());
         }
         ...
         this.screen.drawString("Space Mod added by anonymous tipster", this.nWidth / 3 - fontmetrics.stringWidth("Written by Quin Pendragon") / 2, this.nHeight / 2 + fontmetrics.getHeight() * 3);
      }
   ...
   public SpaceSlime() {
      this.slimaryCols = new Color[]{Color.cyan, Color.red, Color.green, Color.white, this.darkGreen, Color.white, this.darkRed, this.darkRed, new Color(119, 41, 28), Color.yellow, Color.green, Color.white, Color.white, new Color(128, 128, 255), this.darkBlue, Color.white, Color.red, Color.white, new Color(119, 41, 28), Color.green, Color.white, Color.white, Color.white, new Color(185, 30, 2), Color.white, Color.red, new Color(252, 239, 82), Color.white, Color.red, new Color(16, 180, 180), new Color(241, 245, 71), new Color(230, 230, 230), Color.white, Color.black};
      this.secondaryCols = new Color[]{Color.white, Color.black, Color.yellow, new Color(128, 128, 255), Color.red, Color.red, this.darkBlue, Color.white, Color.white, this.darkBlue, Color.green, Color.black, this.darkBlue, Color.white, Color.white, Color.black, Color.white, Color.red, this.darkGreen, Color.white, new Color(128, 255, 128), new Color(255, 128, 0), this.darkGreen, this.darkBlue, new Color(13, 131, 10), Color.white, Color.black, Color.red, Color.white, Color.black, new Color(7, 177, 33), Color.red, Color.black, Color.black};
      this.frenzyCol = 0;
      this.SMILE_DIFF = 2;
      this.DAMPING = 7;
   ...
   private void method_rn_SpaceSlime_p_1(String s) {
