...
public class DodgeBallSlime extends Applet implements Runnable {
   private int nWidth;
   private int nHeight;
   private int p1Score;
   private int p2Score;
   ...
   private Color ballCol;
   private Color SlimaryColsOriginal;
   int ballCount;
   private int swapped;
   int p1Throw;
   int p2Throw;
   ...
   public void paint(Graphics g) {
      ...
      if(!this.fInPlay) {
         ...
         this.screen.setColor(Color.white);
         if(this.fSuperSlime) {
            this.screen.drawString("Super Dodgeball Slime!", this.nWidth / 2 - fontmetrics.stringWidth("Super Soccer Slime!") / 2, this.nHeight / 2 - fontmetrics.getHeight());
         } else {
            this.screen.drawString("Dodgeball Slime!", this.nWidth / 2 - fontmetrics.stringWidth("Soccer Slime!") / 2, this.nHeight / 2 - fontmetrics.getHeight());
         }
   ...
   public DodgeBallSlime() {
      ...
      this.ballCol = Color.red;
      this.SlimaryColsOriginal = Color.red;
      this.ballCount = 11;
      this.swapped = 0;
      this.p1Throw = 1;
      this.p2Throw = 0;
   ...
   private void MoveBall() {
      ++this.ballCount;
      if(this.ballCount > 5) {
         this.ballCol = Color.pink;
      }

      if(this.ballCount > 10) {
         this.ballCol = Color.yellow;
      }
   ...
   private void DrawStatus() {
      ...
      if(this.gameTime < (long)(this.gameLength / 2)) {
         this.p1Throw = 0;
         this.p2Throw = 1;
         if(this.swapped == 0) {
            this.promptMsg = "SWAP!";
   ...
   private void method_rn_DodgeBallSlime_p_1(String s) {
