...
public class Class_rn_f_2 extends Class_rn_c_1 {
   ...
   public void method_rn_c_a_11() {
      if(this.void < 500 && this.field_rn_f_n_38 != -1) {
      ...
      if((this.do != 0 || this.void != 800) && this.field_rn_f_n_38 == -1) {
         if(var1 < 500) {
            ...
            if(Math.abs(this.int - var1) < var3) {
               ...
               } else if(this.method_rn_f_long_33(this.void - this.int) * 2 + this.method_rn_f_long_33(this.else - this.for) < this.method_rn_f_long_33(170) && this.void != this.int) {
                  this.method_rn_f_try_36();
            ...
            if(this.for == 0 && this.field_rn_f_n_38 == -1) {
               if(Math.abs(this.int - var1) < var3) {
                  this.a(3);
         ...
         case 0:
            if(this.else < 250 && this.if < -3) {
               this.a(1);
               this.a(2);
            }
            break;
         case 1:
            if(this.else < 250 && this.if < 0) {
               this.a(0);
               this.a(2);
            }
         }
