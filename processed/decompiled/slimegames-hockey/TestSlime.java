...
public class TestSlime extends Applet implements Runnable {
   private int nWidth;
   private int nHeight;
   private int p1Score;
   private int p2Score;
   ...
   private boolean fP1Fast;
   private boolean fP2Sticky;
   private boolean fP2Fast;
   ...
   private void DrawSlimers() {
      ...
      if(this.p2Blink == 0) {
         this.screen.setColor(!flag?Color.white:Color.white);
         this.screen.fillOval(i - i3, l - j3, i3, j3);
         if(k4 > 0 && !flag) {
            this.screen.setColor(Color.black);
            this.screen.fillOval(i - 4 * i4 / k4 - 3 * i3 / 4, l - 4 * j4 / k4 - 3 * j3 / 4, i3 / 2, j3 / 2);
   ...
   public void paint(Graphics g) {
      ...
      if(!this.fInPlay) {
         ...
         this.screen.setColor(Color.white);
         if(this.fSuperSlime) {
            this.screen.drawString("Super Hockey Slime!", this.nWidth / 2 - fontmetrics.stringWidth("Super Soccer Slime!") / 2, this.nHeight / 2 - fontmetrics.getHeight());
         } else {
            this.screen.drawString("Hockey Slime!", this.nWidth / 2 - fontmetrics.stringWidth("Soccer Slime!") / 2, this.nHeight / 2 - fontmetrics.getHeight());
         }
   ...
   private void method_rn_TestSlime_p_1(String s) {
