...
public class WorldCupSoccerSlime extends Applet implements Runnable {
   private int nWidth;
   private int nHeight;
   private int p1Score;
   private int p2Score;
   ...
   private int p1Col;
   private int p2Col;
   private String[] slimeColText = new String[]{"Argentina", "Belgium", "Australia", "Cameroon", "P.R. of China", "Costa Rica", "Croatia", "Denmark", "Eucador", "Mexico", "France", "USA", "Italy", "Japan", "Russia", "Paraguay", "Poland", "Portugal", "Ireland", "Saudi Arabia", "Senegal", "Slovenia", "Spain", "Seth Efrica", "South Corea", "Sveden", "Tunisia", "Turkey", "Uruguay", "Brazil", "England", "Germany"};
   ...
   private void drawButtons() {
      String[] var1 = new String[]{"1 minute", "2 minutes", "4 minutes", "8 minutes", "World Cup"};
   ...
   public void paint(Graphics var1) {
      ...
      if(!this.fInPlay) {
         ...
         this.screen.setColor(Color.white);
         if(this.fSuperSlime) {
            this.screen.drawString("Super Soccer Slime!", this.nWidth / 2 - var2.stringWidth("Super Soccer Slime!") / 2, this.nHeight / 2 - var2.getHeight());
         } else {
            this.screen.drawString("Soccer Slime!", this.nWidth / 2 - var2.stringWidth("Soccer Slime!") / 2, this.nHeight / 2 - var2.getHeight());
         }

         this.screen.setColor(Color.white);
         var2 = this.screen.getFontMetrics();
         this.screen.drawString("Written by Quin Pendragon", this.nWidth / 2 - var2.stringWidth("Written by Quin Pendragon") / 2, this.nHeight / 2 + var2.getHeight() * 2);
      }
   ...
   public WorldCupSoccerSlime() {
      this.slimaryCols = new Color[]{Color.cyan, Color.red, Color.green, this.darkGreen, Color.white, this.darkRed, this.darkRed, new Color(119, 41, 28), Color.yellow, Color.green, Color.white, Color.white, new Color(128, 128, 255), this.darkBlue, Color.white, Color.red, Color.white, new Color(119, 41, 28), Color.green, Color.white, Color.white, Color.white, new Color(185, 30, 2), Color.white, Color.red, new Color(252, 239, 82), Color.white, Color.red, new Color(16, 180, 180), new Color(241, 245, 71), new Color(230, 230, 230), Color.white};
      this.secondaryCols = new Color[]{Color.white, Color.black, Color.yellow, Color.red, Color.red, this.darkBlue, Color.white, Color.white, this.darkBlue, Color.green, Color.blue, this.darkBlue, Color.white, Color.white, Color.blue, Color.white, Color.red, this.darkGreen, Color.white, new Color(128, 255, 128), new Color(255, 128, 0), this.darkGreen, this.darkBlue, new Color(13, 131, 10), Color.white, Color.blue, Color.red, Color.white, Color.black, new Color(7, 177, 33), Color.red, Color.black};
      this.SMILE_DIFF = 2;
      this.DAMPING = 7;
   ...
   private void DrawGoals() {
      ...
      for(int var1 = 0; var1 < this.nWidth / 20; var1 += 5) {
         this.screen.drawLine(var1, 4 * this.nHeight / 5 - 200 * this.nHeight / 1000, var1, 4 * this.nHeight / 5);
         this.screen.drawLine(this.nWidth - var1, 4 * this.nHeight / 5 - 200 * this.nHeight / 1000, this.nWidth - var1, 4 * this.nHeight / 5);
      }

      for(int var2 = 4 * this.nHeight / 5 - this.nHeight / 5; var2 < 4 * this.nHeight / 5; var2 += 5) {
         this.screen.drawLine(0, var2, this.nWidth / 20, var2);
         this.screen.drawLine(this.nWidth, var2, this.nWidth - this.nWidth / 20, var2);
      }
   ...
   private void drawScores() {
      ...
      String var4 = this.p2Score + " : " + this.slimeColText[this.p2Col];
      var1.drawString(var4, this.nWidth - this.nWidth / 20 - var3.stringWidth(var4), var2);
   }
   ...
   private void method_rn_WorldCupSoccerSlime_p_1(String var1) {
