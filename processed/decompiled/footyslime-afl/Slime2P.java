...
public class Slime2P extends Applet implements Runnable {
   ...
   private boolean holdingOn = true;
   ...
   public void init() {
      ...
      for(int var1 = 0; var1 < this.NUM_PARTICLES; ++var1) {
         ...
         this.particle_y[var1] = (int)(-Math.random() * 50.0D);
         this.particle_weight[var1] = (float)(Math.random() * 0.95D + 0.05D);
      }

      this.slimeColText = new String[]{"West Coast Slime ", "Anchor Slime ", "Alpha Centauri Slime ", "Eddie McSlimer ", "Yellow and Black Slime ", "Bomber Slime ", "Navy Blue Slime ", "Hawthorn Slime ", "Ford Factory Slime ", "Sydney Slime ", "Demon Slime ", "Camry Slime ", "Saint Slimer ", "Western Bullslime ", "Brisbane Slime ", "Slime Power "};
      this.slimeColours = new Color[]{new Color(0, 0, 135), new Color(0, 40, 90), Color.white, Color.white, Color.black, Color.black, new Color(0, 0, 60), new Color(255, 255, 0), Color.white, Color.white, new Color(0, 0, 60), Color.black, Color.red, new Color(0, 0, 160), new Color(160, 60, 60), Color.black};
      this.slimeColours2 = new Color[]{Color.yellow, Color.white, new Color(30, 30, 255), Color.black, Color.yellow, Color.red, Color.white, new Color(142, 32, 32), new Color(0, 0, 100), Color.red, Color.red, Color.red, Color.black, Color.red, new Color(20, 20, 255), new Color(140, 180, 195)};
      this.field_rn_Slime2P_pw_1 = ".....".toCharArray();
      this.buffer = this.createImage(this.nWidth, this.nHeight);
      if(this.buffered) {
         this.buffered = false;

         for(int var2 = 0; var2 < this.bfr.length(); ++var2) {
            this.pwAddChar(this.bfr.toCharArray()[var2]);
         }
      }
   ...
   public void paint(Graphics var1) {
      ...
      if(!this.fInPlay) {
         ...
         if(this.fP1PointsWon + this.fP2PointsWon > 0) {
            if(this.firstHalf) {
               this.screen.drawString("AFL Slime Volleyball!", this.nWidth / 2 - var3.stringWidth("AFL Slime Volleyball!") / 2, this.nHeight / 2 - var3.getHeight() * 5);
            }
            ...
            String[][] var5 = new String[][]{{100L * this.fP1Frames / (this.fP1Frames + this.fP2Frames) + "%", String.valueOf(this.fP1TouchesTot), String.valueOf(this.fP1PointsWon), String.valueOf(this.fP1Winners), String.valueOf(this.fP1Aces), String.valueOf(this.fP1Clangers), String.valueOf(this.fP1Super), String.valueOf(this.fP1Streak)}, {100L - 100L * this.fP1Frames / (this.fP1Frames + this.fP2Frames) + "%", String.valueOf(this.fP2TouchesTot), String.valueOf(this.fP2PointsWon), String.valueOf(this.fP2Winners), String.valueOf(this.fP2Aces), String.valueOf(this.fP2Clangers), String.valueOf(this.fP2Super), String.valueOf(this.fP2Streak)}};
            int var6 = 0;
            ...
            this.screen.drawString("AFL Slime Volleyball!", this.nWidth / 2 - var3.stringWidth("AFL Slime Volleyball!") / 2, this.nHeight / 2 - var3.getHeight());
            var2.setColor(Color.white);
            var3 = var2.getFontMetrics();
   ...
   private void changeCols() {
      if((this.p1Col != 2 || this.p2Col != 3) && (this.p1Col != 3 || this.p2Col != 2)) {
         if((this.p1Col != 6 || this.p2Col != 11) && (this.p1Col != 11 || this.p2Col != 6)) {
            ...
            this.slimeColours2[2] = new Color(30, 30, 255);
            this.slimeColText[6] = "Navy Blue Slime ";
            this.slimeColours[6] = new Color(0, 0, 60);
         } else {
            this.slimeColText[6] = "Light Blue Slime ";
            this.slimeColours[6] = new Color(30, 30, 255);
         }
      } else {
         this.slimeColText[2] = "Orangeroo Slime ";
         this.slimeColours2[2] = Color.orange;
      }
   }
   ...
   private void DrawStrip(Graphics var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      case 12:
         ...
         var1.fillPolygon(new Polygon(new int[]{var2 + var4 / 3, var2 + 2 * var4 / 3, var2 + 2 * var4 / 3, var2 + var4 / 3}, new int[]{var3 + var5, var3 + var5, (int)(0.058D * (double)var5 + (double)var3), (int)(0.058D * (double)var5 + (double)var3)}, 4));
         var1.fillArc(var2, var3, var4, 2 * var5, 70, 40);
         return;
      case 1:
         var1.setColor(var7?Color.red:new Color(0, 100, 0));
         var1.fillArc(var2, var3, var4, 2 * var5, 90, 65);
         var1.setColor(var7?new Color(0, 100, 0):Color.red);
         var1.fillArc(var2, var3, var4, 2 * var5, 25, 65);
         var1.setColor(var7?this.slimeColours[var6]:this.slimeColours2[var6]);
         var1.fillPolygon(new Polygon(new int[]{var2 + 7 * var4 / 16, var2 + 9 * var4 / 16, var2 + 9 * var4 / 16, (int)(0.953D * (double)var4 + (double)var2), var2 + var4 / 2, (int)(0.047D * (double)var4 + (double)var2), var2 + 7 * var4 / 16}, new int[]{(int)(0.008D * (double)var5 + (double)var3), (int)(0.008D * (double)var5 + (double)var3), var3 + 3 * var5 / 4, (int)(0.577D * (double)var5 + (double)var3), var3 + var5, (int)(0.577D * (double)var5 + (double)var3), var3 + 3 * var5 / 4}, 7));
      ...
      case 7:
         ...
         var1.setColor(var7?this.slimeColours2[var6]:this.slimeColours[var6]);
         var1.fillPolygon(new Polygon(new int[]{var2 + 2 * var4 / 5, var2 + 3 * var4 / 5, var2 + 3 * var4 / 5, var2 + 2 * var4 / 5}, new int[]{(int)(0.04D * (double)var5 + (double)var3), (int)(0.04D * (double)var5 + (double)var3), var3 + var5, var3 + var5}, 4));
         var1.fillArc(var2, var3, var4, 2 * var5, 78, 24);
         return;
      case 4:
      case 5:
         var1.fillPolygon(new Polygon(new int[]{var2 + var4 / 2, var2, var2 + var4 / 2}, new int[]{var3, var3 + var5, var3 + var5}, 3));
         var1.fillArc(var2, var3, var4, 2 * var5, 45, 45);
         return;
      case 6:
         var1.drawArc(var2 + var4 / 4, var3 + var5 / 4, var4 / 2, var5 / 2, 60, 240);
         var1.drawArc(var2 + var4 / 3, var3 + var5 / 3, var4 / 3, var5 / 3, 60, 240);
         var1.drawLine(var2 + 3 * var4 / 8, var3 + var5 / 6, var2 + 3 * var4 / 8, var3 + 5 * var5 / 6);
         var1.drawLine(var2 + 3 * var4 / 8, var3 + var5 / 6, var2 + 2 * var4 / 3, var3 + var5 / 6);
         var1.drawLine(var2 + 3 * var4 / 8, var3 + var5 / 2, var2 + 5 * var4 / 8, var3 + var5 / 2);
         return;
      case 8:
      case 11:
      case 13:
         ...
         if(var6 != 11) {
            ...
            var1.setColor(var7?Color.white:Color.yellow);
      ...
      case 15:
         ...
         var1.setColor(var7?this.slimeColours2[var6]:this.slimeColours[var6]);
         var1.fillRect((int)(0.128D * (double)var4 + (double)var2), var3 + var5 / 3, (int)(0.744D * (double)var4), 2 * var5 / 3);
         var1.setColor(var7?Color.black:Color.white);

         for(int var8 = 0; var8 < 3; ++var8) {
            var1.fillPolygon(new Polygon(new int[]{(int)(0.124D * (double)var8 * (double)var4 + (double)(var4 / 2) + (double)var2), (int)(0.124D * (double)(var8 - 1) * (double)var4 + (double)(var4 / 2) + (double)var2), (int)(0.124D * (double)(var8 + 1) * (double)var4 + (double)(var4 / 2) + (double)var2)}, new int[]{var3 + var5 / 3, var3 + var5, var3 + var5 / 3}, 3));
         }
   ...
   private void drawScores() {
      ...
      for(int var6 = 0; var6 < this.fP1PointsWon / 6; ++var6) {
      ...
      if(this.fP1PointsWon >= 12) {
         var1.drawString(String.valueOf(this.fP1PointsWon / 6), var5 - var2.stringWidth(String.valueOf(this.fP1PointsWon / 6)) / 2, 30 + var2.getAscent() / 2);
      }
      ...
      for(int var7 = 0; var7 < this.fP1PointsWon % 6; ++var7) {
         var1.setColor(this.slimeColours[this.p1Col]);
      ...
      var5 = this.nWidth - 20 - this.fP2PointsWon / 6 * var4 / 2 - (this.fP2PointsWon % 6 == 0?var4 / 2 + 10:0) - this.fP2PointsWon % 6 * var3 - (this.fP2PointsWon % 6 > 0?this.fP2PointsWon % 6 - 1:0) * 5;
      if(this.fP2PointsWon > 6 && this.fP2PointsWon % 6 != 0) {
         var5 -= var4 / 2 + 10;
      }

      for(int var8 = 0; var8 < this.fP2PointsWon / 6; ++var8) {
      ...
      if(this.fP2PointsWon >= 12) {
         var1.drawString(String.valueOf(this.fP2PointsWon / 6), var5 - var2.stringWidth(String.valueOf(this.fP2PointsWon / 6)) / 2, 30 + var2.getAscent() / 2);
      }
      ...
      for(int var9 = 0; var9 < this.fP2PointsWon % 6; ++var9) {
         var1.setColor(this.slimeColours[this.p2Col]);
         var1.fillOval(var5, 30 - var3 / 2, var3, var3);
         var1.setColor(this.slimeColours2[this.p2Col]);
         var1.drawOval(var5, 30 - var3 / 2, var3, var3);
   ...
   private String MakeTime(long var1) {
      String var3 = "";
      long var4 = var1 / 1000L % 60L;
      long var6 = var1 / 60000L % 60L;
      var3 = var3 + var6 + ":";
      if(var4 < 10L) {
         var3 = var3 + "0";
      }
