import { Applet, Runnable, Color, Graphics, Thread, Image, FontMetrics, ImageObserver, Event, Font, System, BufferedImage, Frame, Element, GridLayout, TextField, Button, Panel, Label } from "../../ts/client/shims"

EndOfShimDeclarations["__class"] = "EndOfShimDeclarations";


export default class BowlingSlime2 extends Applet implements Runnable {
    ...
    /*public*/ lightBrown : Color = new Color(100, 65, 0);
    ...
    /*public*/ maxballX : number;

    /*public*/ minballX : number;
    ...
    /*public*/ method_rn_BowlingSlime2_p_1(var1 : string) {
...
BowlingSlime2["__interfaces"] = ["Runnable"];
