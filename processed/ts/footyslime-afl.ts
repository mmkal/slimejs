import { Applet, Runnable, Graphics, Thread, Color, Image, Font, FontMetrics, Event, System, Polygon, ImageObserver, BufferedImage, Frame, Element, GridLayout, TextField, Button, Panel, Label } from "../../ts/client/shims"
...
export default class Slime2P extends Applet implements Runnable {
    ...
    public init() {
        ...
        for(let var1 : number = 0; var1 < this.NUM_PARTICLES; ++var1) {
            ...
            this.particle_y[var1] = (<number>(-Math.random() * 50.0)|0);
            this.particle_weight[var1] = <number>(Math.random() * 0.95 + 0.05);
        };
        ...
        this.slimeColours = [new Color(0, 0, 135), new Color(0, 40, 90), Color.fromString("white"), Color.fromString("white"), Color.fromString("black"), Color.fromString("black"), new Color(0, 0, 60), new Color(255, 255, 0), Color.fromString("white"), Color.fromString("white"), new Color(0, 0, 60), Color.fromString("black"), Color.fromString("red"), new Color(0, 0, 160), new Color(160, 60, 60), Color.fromString("black")];
        this.slimeColours2 = [Color.fromString("yellow"), Color.fromString("white"), new Color(30, 30, 255), Color.fromString("black"), Color.fromString("yellow"), Color.fromString("red"), Color.fromString("white"), new Color(142, 32, 32), new Color(0, 0, 100), Color.fromString("red"), Color.fromString("red"), Color.fromString("red"), Color.fromString("black"), Color.fromString("red"), new Color(20, 20, 255), new Color(140, 180, 195)];
        this.field_rn_Slime2P_pw_1 = /* toCharArray */(".....").split('');
        this.buffer = this.createImage(this.nWidth, this.nHeight);
        if(this.buffered) {
            this.buffered = false;
            for(let var2 : number = 0; var2 < this.bfr.length; ++var2) {
    ...
    public paint(var1 : Graphics) {
        ...
        if(!this.fInPlay) {
            ...
            if(this.fP1PointsWon + this.fP2PointsWon > 0) {
                ...
                let var5 : string[][] = [[Math.floor(100 * this.fP1Frames / (this.fP1Frames + this.fP2Frames)) + "%", /* valueOf */new String(this.fP1TouchesTot).toString(), /* valueOf */new String(this.fP1PointsWon).toString(), /* valueOf */new String(this.fP1Winners).toString(), /* valueOf */new String(this.fP1Aces).toString(), /* valueOf */new String(this.fP1Clangers).toString(), /* valueOf */new String(this.fP1Super).toString(), /* valueOf */new String(this.fP1Streak).toString()], [100 - Math.floor(100 * this.fP1Frames / (this.fP1Frames + this.fP2Frames)) + "%", /* valueOf */new String(this.fP2TouchesTot).toString(), /* valueOf */new String(this.fP2PointsWon).toString(), /* valueOf */new String(this.fP2Winners).toString(), /* valueOf */new String(this.fP2Aces).toString(), /* valueOf */new String(this.fP2Clangers).toString(), /* valueOf */new String(this.fP2Super).toString(), /* valueOf */new String(this.fP2Streak).toString()]];
                let var6 : number = 0;
    ...
    /*public*/ pwAddChar(var1 : string) {
        ...
        } else if(/* equals */(<any>((o1: any, o2: any) => { if(o1 && o1.equals) { return o1.equals(o2); } else { return o1 === o2; } })(var3,this.bal))) {
            var4 = true;
    ...
    /*public*/ changeCols() {
        if((this.p1Col !== 2 || this.p2Col !== 3) && (this.p1Col !== 3 || this.p2Col !== 2)) {
            ...
            this.slimeColours2[2] = Color.fromString("orange");
        }
    }
    ...
    /*public*/ DrawStrip(var1 : Graphics, var2 : number, var3 : number, var4 : number, var5 : number, var6 : number) {
        ...
        case 12:
            ...
            var1.fillPolygon$Polygon(new Polygon([var2 + (var4 / 3|0), var2 + (2 * var4 / 3|0), var2 + (2 * var4 / 3|0), var2 + (var4 / 3|0)], [var3 + var5, var3 + var5, (<number>(0.058 * <number>var5 + <number>var3)|0), (<number>(0.058 * <number>var5 + <number>var3)|0)], 4));
            var1.fillArc(var2, var3, var4, 2 * var5, 70, 40);
            return;
        case 1:
            var1.setColor(var7?Color.fromString("red"):new Color(0, 100, 0));
            var1.fillArc(var2, var3, var4, 2 * var5, 90, 65);
            var1.setColor(var7?new Color(0, 100, 0):Color.fromString("red"));
            var1.fillArc(var2, var3, var4, 2 * var5, 25, 65);
            var1.setColor(var7?this.slimeColours[var6]:this.slimeColours2[var6]);
            var1.fillPolygon$Polygon(new Polygon([var2 + (7 * var4 / 16|0), var2 + (9 * var4 / 16|0), var2 + (9 * var4 / 16|0), (<number>(0.953 * <number>var4 + <number>var2)|0), var2 + (var4 / 2|0), (<number>(0.047 * <number>var4 + <number>var2)|0), var2 + (7 * var4 / 16|0)], [(<number>(0.008 * <number>var5 + <number>var3)|0), (<number>(0.008 * <number>var5 + <number>var3)|0), var3 + (3 * var5 / 4|0), (<number>(0.577 * <number>var5 + <number>var3)|0), var3 + var5, (<number>(0.577 * <number>var5 + <number>var3)|0), var3 + (3 * var5 / 4|0)], 7));
        ...
        case 7:
            ...
            var1.setColor(var7?this.slimeColours2[var6]:this.slimeColours[var6]);
            var1.fillPolygon$Polygon(new Polygon([var2 + (2 * var4 / 5|0), var2 + (3 * var4 / 5|0), var2 + (3 * var4 / 5|0), var2 + (2 * var4 / 5|0)], [(<number>(0.04 * <number>var5 + <number>var3)|0), (<number>(0.04 * <number>var5 + <number>var3)|0), var3 + var5, var3 + var5], 4));
            var1.fillArc(var2, var3, var4, 2 * var5, 78, 24);
            return;
        case 4:
        case 5:
            var1.fillPolygon$Polygon(new Polygon([var2 + (var4 / 2|0), var2, var2 + (var4 / 2|0)], [var3, var3 + var5, var3 + var5], 3));
        ...
        case 13:
            ...
            if(var6 !== 11) {
                ...
                var1.setColor(var7?Color.fromString("white"):Color.fromString("yellow"));
        ...
        case 15:
            ...
            var1.setColor(var7?this.slimeColours2[var6]:this.slimeColours[var6]);
            var1.fillRect((<number>(0.128 * <number>var4 + <number>var2)|0), var3 + (var5 / 3|0), (<number>(0.744 * <number>var4)|0), (2 * var5 / 3|0));
            var1.setColor(var7?Color.fromString("black"):Color.fromString("white"));
            for(let var8 : number = 0; var8 < 3; ++var8) {
                var1.fillPolygon$Polygon(new Polygon([(<number>(0.124 * <number>var8 * <number>var4 + <number>((var4 / 2|0)) + <number>var2)|0), (<number>(0.124 * <number>(var8 - 1) * <number>var4 + <number>((var4 / 2|0)) + <number>var2)|0), (<number>(0.124 * <number>(var8 + 1) * <number>var4 + <number>((var4 / 2|0)) + <number>var2)|0)], [var3 + (var5 / 3|0), var3 + var5, var3 + (var5 / 3|0)], 3));
            };
            return;
        default:
        }
    ...
    /*public*/ drawScores() {
        ...
        let var5 : number = 20;
        for(let var6 : number = 0; var6 < (this.fP1PointsWon / 6|0); ++var6) {
        ...
        for(let var7 : number = 0; var7 < this.fP1PointsWon % 6; ++var7) {
            var1.setColor(this.slimeColours[this.p1Col]);
        ...
        for(let var8 : number = 0; var8 < (this.fP2PointsWon / 6|0); ++var8) {
        ...
        for(let var9 : number = 0; var9 < this.fP2PointsWon % 6; ++var9) {
            var1.setColor(this.slimeColours[this.p2Col]);
            var1.fillOval(var5, 30 - (var3 / 2|0), var3, var3);
            var1.setColor(this.slimeColours2[this.p2Col]);
            var1.drawOval(var5, 30 - (var3 / 2|0), var3, var3);
    ...
    /*public*/ MakeTime(var1 : number) : string {
        let var3 : string = "";
        let var4 : number = Math.floor(var1 / 1000) % 60;
        let var6 : number = Math.floor(var1 / 60000) % 60;
        var3 = var3 + var6 + ":";
        if(var4 < 10) {
            var3 = var3 + "0";
        }
