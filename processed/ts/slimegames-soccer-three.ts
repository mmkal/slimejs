...
export default class ThreePSLime extends Applet implements Runnable {
    ...
    public constructor() {
        ...
        this.secondaryCols = [Color.fromString("white"), Color.fromString("black"), Color.fromString("yellow"), new Color(128, 128, 255), Color.fromString("red"), Color.fromString("red"), this.darkBlue, Color.fromString("white"), Color.fromString("white"), this.darkBlue, Color.fromString("green"), Color.fromString("blue"), this.darkBlue, Color.fromString("white"), Color.fromString("white"), Color.fromString("blue"), Color.fromString("white"), Color.fromString("red"), this.darkGreen, Color.fromString("white"), new Color(128, 255, 128), new Color(255, 128, 0), this.darkGreen, this.darkBlue, new Color(13, 131, 10), Color.fromString("white"), Color.fromString("blue"), Color.fromString("red"), Color.fromString("white"), Color.fromString("black"), new Color(7, 177, 33), Color.fromString("red"), Color.fromString("black"), Color.fromString("blue"), Color.fromString("blue")];
        this.frenzyCol = 0;
        this.SMILE_DIFF = 2;
        this.DAMPING = 7;
    ...
    /*public*/ method_rn_ThreePSLime_p_1(s : string) {
        System.out.println$java_lang_Object(s);
    }
}
ThreePSLime["__class"] = "ThreePSLime";
ThreePSLime["__interfaces"] = ["Runnable"];
