...
export default class TestSlime extends Applet implements Runnable {
    ...
    /*public*/ fP1Fast : boolean;

    /*public*/ fP2Sticky : boolean;

    /*public*/ fP2Fast : boolean;
    ...
    /*public*/ DrawSlimers() {
        ...
        if(this.p2Blink === 0) {
            this.screen.setColor(!flag?Color.fromString("white"):Color.fromString("white"));
            this.screen.fillOval(i - i3, l - j3, i3, j3);
            if(k4 > 0 && !flag) {
                this.screen.setColor(Color.fromString("black"));
                this.screen.fillOval(i - (4 * i4 / k4|0) - (3 * i3 / 4|0), l - (4 * j4 / k4|0) - (3 * j3 / 4|0), (i3 / 2|0), (j3 / 2|0));
    ...
    /*public*/ method_rn_TestSlime_p_1(s : string) {
        System.out.println$java_lang_Object(s);
    }
}
TestSlime["__class"] = "TestSlime";
TestSlime["__interfaces"] = ["Runnable"];
