...
export default class RugbySlime extends Applet implements Runnable {
    ...
    /*public*/ fP1Stuck : boolean;

    /*public*/ fP2Stuck : boolean;
    ...
    /*public*/ drawButtons() {
        ...
        let darkBlue : Color = new Color(200, 0, 0);
    ...
    /*public*/ DrawSlimers() {
        ...
        if(this.p2Blink === 0) {
            this.screen.setColor(!flag?Color.fromString("white"):Color.fromString("green"));
            this.screen.fillOval(i - i3, l - j3, i3, j3);
            if(k4 > 0 && !flag) {
                this.screen.setColor(Color.fromString("black"));
                this.screen.fillOval(i - (4 * i4 / k4|0) - (3 * i3 / 4|0), l - (4 * j4 / k4|0) - (3 * j3 / 4|0), (i3 / 2|0), (j3 / 2|0));
    ...
    /*public*/ DrawGoals() {
        ...
        let p2TickX : number = this.nWidth - ((60000 - this.p2TouchingGoal) * this.nWidth / 120000|0);
        this.screen.setColor(this.secondaryCols[this.p2Col]);
    ...
    /*public*/ method_rn_RugbySlime_p_1(s : string) {
        System.out.println$java_lang_Object(s);
    }
}
RugbySlime["__class"] = "RugbySlime";
RugbySlime["__interfaces"] = ["Runnable"];
