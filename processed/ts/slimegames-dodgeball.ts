...
export default class DodgeBallSlime extends Applet implements Runnable {
    ...
    /*public*/ ballCol : Color;

    /*public*/ SlimaryColsOriginal : Color;
    ...
    public constructor() {
        ...
        this.ballCol = Color.fromString("red");
        this.SlimaryColsOriginal = Color.fromString("red");
        this.ballCount = 11;
        this.swapped = 0;
        this.p1Throw = 1;
        this.p2Throw = 0;
    ...
    /*public*/ MoveBall() {
        ++this.ballCount;
        if(this.ballCount > 5) {
            this.ballCol = Color.fromString("pink");
        }
        if(this.ballCount > 10) {
            this.ballCol = Color.fromString("yellow");
        }
        ...
        if(!this.fEndGame) {
            let l1 : number = (this.ballX - this.p1X) * 1;
            if(this.p1Throw === 1) {
    ...
    /*public*/ DrawStatus() {
        ...
        if(this.gameTime < Math.floor(<number>((this.gameLength / 2|0)))) {
            this.p1Throw = 0;
            this.p2Throw = 1;
            if(this.swapped === 0) {
                this.promptMsg = "SWAP!";
    ...
    /*public*/ method_rn_DodgeBallSlime_p_1(s : string) {
        System.out.println$java_lang_Object(s);
    }
}
DodgeBallSlime["__class"] = "DodgeBallSlime";
DodgeBallSlime["__interfaces"] = ["Runnable"];
