...
export default class ElasticSlime extends Applet implements Runnable {
    ...
    /*public*/ method_rn_ElasticSlime_p_1(s : string) {
        System.out.println$java_lang_Object(s);
    }
}
ElasticSlime["__class"] = "ElasticSlime";
ElasticSlime["__interfaces"] = ["Runnable"];
