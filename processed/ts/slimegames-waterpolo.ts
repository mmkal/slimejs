...
export default class WaterPoloSlime extends Applet implements Runnable {
    ...
    /*public*/ splashStage : number = 1;

    /*public*/ oldSplashX : number = 0;

    /*public*/ oldSplashY : number = 0;

    /*public*/ oldSplashXV : number = 0;

    /*public*/ part1X : number = 110;

    /*public*/ part1Y : number = 110;

    /*public*/ part1Xold : number = 0;

    /*public*/ part1Yold : number = 0;

    /*public*/ part2Xold : number = 0;

    /*public*/ part2Yold : number = 0;

    /*public*/ part3Xold : number = 0;

    /*public*/ part3Yold : number = 0;

    /*public*/ part4Xold : number = 0;

    /*public*/ part4Yold : number = 0;

    /*public*/ part5Xold : number = 0;

    /*public*/ part5Yold : number = 0;

    /*public*/ part6Xold : number = 0;

    /*public*/ part6Yold : number = 0;

    /*public*/ part2X : number = 110;

    /*public*/ part2Y : number = 110;

    /*public*/ part3X : number = 110;

    /*public*/ part3Y : number = 110;

    /*public*/ part4X : number = 0;

    /*public*/ part4Y : number = 0;

    /*public*/ part5X : number = 0;

    /*public*/ part5Y : number = 0;

    /*public*/ part6X : number = 0;

    /*public*/ part6Y : number = 0;

    /*public*/ part7X : number = 0;

    /*public*/ part7Y : number = 0;

    /*public*/ part8X : number = 0;

    /*public*/ part8Y : number = 0;
    ...
    NUM_PARTICLES_HIT : number = 30;

    particle_x_HIT : number[];

    particle_y_HIT : number[];

    particle_yv_HIT : number[];

    particle_xv_HIT : number[];

    NUM_PARTICLES_HIT2 : number;

    particle_x_HIT2 : number[];

    particle_y_HIT2 : number[];

    particle_yv_HIT2 : number[];

    particle_xv_HIT2 : number[];

    NUM_PARTICLES_HIT3 : number;

    particle_x_HIT3 : number[];

    particle_y_HIT3 : number[];

    particle_yv_HIT3 : number[];

    particle_xv_HIT3 : number[];
    ...
    /*public*/ DrawSlimers() {
        ...
        this.screen.setColor(new Color(10, 0, 210));
    ...
    public constructor() {
        ...
        this.p1Col = 0;
        this.p2Col = 0;
        this.particle_x_HIT = null;
        this.particle_y_HIT = null;
        this.particle_yv_HIT = null;
        this.particle_xv_HIT = null;
        this.NUM_PARTICLES_HIT2 = 0;
        this.particle_x_HIT2 = null;
        this.particle_y_HIT2 = null;
        this.particle_yv_HIT2 = null;
        this.particle_xv_HIT2 = null;
        this.NUM_PARTICLES_HIT3 = 0;
        this.particle_x_HIT3 = null;
        this.particle_y_HIT3 = null;
        this.particle_yv_HIT3 = null;
        this.particle_xv_HIT3 = null;
        ...
        this.pointsX = null;
        this.pointsY = null;
        this.particle_x_HIT = (s => { let a=[]; while(s-->0) a.push(0); return a; })(this.NUM_PARTICLES_HIT);
        this.particle_y_HIT = (s => { let a=[]; while(s-->0) a.push(0); return a; })(this.NUM_PARTICLES_HIT);
        this.particle_yv_HIT = (s => { let a=[]; while(s-->0) a.push(0); return a; })(this.NUM_PARTICLES_HIT);
        this.particle_xv_HIT = (s => { let a=[]; while(s-->0) a.push(0); return a; })(this.NUM_PARTICLES_HIT);
        this.NUM_PARTICLES_HIT2 = 30;
        this.particle_x_HIT2 = (s => { let a=[]; while(s-->0) a.push(0); return a; })(this.NUM_PARTICLES_HIT2);
        this.particle_y_HIT2 = (s => { let a=[]; while(s-->0) a.push(0); return a; })(this.NUM_PARTICLES_HIT2);
        this.particle_yv_HIT2 = (s => { let a=[]; while(s-->0) a.push(0); return a; })(this.NUM_PARTICLES_HIT2);
        this.particle_xv_HIT2 = (s => { let a=[]; while(s-->0) a.push(0); return a; })(this.NUM_PARTICLES_HIT2);
        this.NUM_PARTICLES_HIT3 = 30;
        this.particle_x_HIT3 = (s => { let a=[]; while(s-->0) a.push(0); return a; })(this.NUM_PARTICLES_HIT3);
        this.particle_y_HIT3 = (s => { let a=[]; while(s-->0) a.push(0); return a; })(this.NUM_PARTICLES_HIT3);
        this.particle_yv_HIT3 = (s => { let a=[]; while(s-->0) a.push(0); return a; })(this.NUM_PARTICLES_HIT3);
        this.particle_xv_HIT3 = (s => { let a=[]; while(s-->0) a.push(0); return a; })(this.NUM_PARTICLES_HIT3);
        ...
        this.Lightblue = new Color(0, 0, 0);
    ...
    /*public*/ updateParticlesHit() {
        for(let i : number = 0; i < this.NUM_PARTICLES_HIT; ++i) {
            let incrY : number = (<number>(Math.random() * 2.0 + 1.0)|0);
            let incrX : number = (<number>(Math.random() * <number>this.ballVX + 5.0)|0);
            let randY : number = (<number>(Math.random() * <number>this.ballVY + 1.0)|0);
    ...
    /*public*/ drawParticlesHit() {
        for(let i : number = 0; i < this.NUM_PARTICLES_HIT; ++i) {
            let rand : number = (<number>(Math.random() * 3.0)|0);
            if(rand === 1) {
                this.screen.setColor(new Color(100, 100, 250));
            }
            if(rand === 2) {
                this.screen.setColor(new Color(200, 200, 250));
            }
            if(rand === 3) {
                this.screen.setColor(new Color(250, 250, 250));
            }
            this.screen.fillOval(this.particle_x_HIT[i], this.particle_y_HIT[i], 3, 3);
        };
    }

    /*public*/ updateParticlesHit2() {
        for(let i : number = 0; i < this.NUM_PARTICLES_HIT2; ++i) {
            let incrY : number = (<number>(Math.random() * 5.0 + 1.0)|0);
            let incrX : number = (<number>(Math.random() * <number>this.p1XV + 1.0)|0);
            let randY : number = (<number>(Math.random() * <number>this.p1YV / 2.0 + 1.0)|0);
    ...
    /*public*/ updateParticlesHit3() {
        for(let i : number = 0; i < this.NUM_PARTICLES_HIT3; ++i) {
            let incrY : number = (<number>(Math.random() * 5.0 + 1.0)|0);
            let incrX : number = (<number>(Math.random() * <number>this.p2XV + 1.0)|0);
            let randY : number = (<number>(Math.random() * <number>this.p2YV / 2.0 + 1.0)|0);
            let randX : number = (<number>(Math.random() * 10.0 + 1.0)|0);
    ...
    /*public*/ method_rn_WaterPoloSlime_p_1(s : string) {
        System.out.println$java_lang_Object(s);
    }
}
WaterPoloSlime["__class"] = "WaterPoloSlime";
WaterPoloSlime["__interfaces"] = ["Runnable"];
